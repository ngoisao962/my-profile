...
const Content = () => {
    return (
        <div className="contact section " id='cantact'>
        ...
        <div className="contact_content">
            ...
            <div className="contact_info">
                <div className="contact_card">
                    ...
                    <span className="contact_card-data">luongvanchuong963@gmail.com</span>
                ...
                <div className="contact_card">
                    ...
                    <span className="contact_card-data">0392759052</span>
                    <a href="" className="contact_button">Write me
                    <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                </div>
                <div className="contact_card">
                    ...
                    <span className="contact_card-data">Chuong Van</span>
                    <a href="" className="contact_button">Write me
                    <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                </div>
            </div>
        ...
        <div className="contact_content">
            ...
            <form action="" className="contact_form">
                ...
                <div className="contact_form-div contact_form-area">
                   ...
                   <textarea name="project" id="" cols="30" rows="10" className='contact_form-input'></textarea>
                </div>
